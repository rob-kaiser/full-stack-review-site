...
import org.springframework.boot.CommandLineRunner;=======>>>>>>>54ef 104d 5d 5 bab0e96ac4ab38d01edd411214c12
import org.springframework.data.repository.CrudRepository;
import org.springframework.stereotype.Component;

@Component
<<<<<<<HEAD public class ReviewRepository implements CommandLineRunner {
	...
	Category asian = new Category("Asian", "images/asian.jpg");categories.put(asian);
	Category steakhouse = new Category("Steakhouse", "images/steakhouse.jpg");categories.put(steakhouse);
	Category italian = new Category("Italian", "images/italian.jpg");categories.put(italian);
	Category mexican = new Category("Mexican", "images/mexican.jpg");categories.put(mexican);
	...
	Review restaurant1 = new Review("Steakhouse", "J. Alexander's", "/images/J.Alexanders.jpg",
			...
			"(614) 847-1166", "7550 Vantage Dr\r\n" + "Columbus, OH 43235");reviews.put(restaurant1);
	...
	Review restaurant2 = new Review("Mexican", "Chile Verde", "/images/ChileVerde.jpg",
			...
			"614-442-6630", "4852 Sawmill Rd, Columbus, OH 43235");reviews.put(restaurant2);
	...
	Review restaurant3 = new Review("Mexican", "Condados Tacos", "/images/CondadosTacos.jpg",
			...
			"614-928-3909", "1227 N High St, Columbus, OH 43201");reviews.put(restaurant3);
	...
	Review restaurant4 = new Review("Italian", "Bravo Cucina Italiana", "/images/BravoCrosswoods.jpg",
			...
			"(614) 888-3881", "7470 Vantage Drive\r\n" + "Columbus, OH 43235");reviews.put(restaurant4);
	...
	Review restaurant5 = new Review("Italian", "Bucci Di Beppo", "/images/BuciDiBepo.jpg",
			...
			"614-621-3287", "343 N Front St Columbus, Ohio 43215");reviews.put(restaurant5);
	...
	Review restaurant6 = new Review("Asian", "Sushi Time", "/images/SushiTime.jpg",
			...
			"614-372-5228", "2653 N High St, Columbus, OH 43202");reviews.put(restaurant6);
